 ...
 */
public class Downloadfunc extends Thread {
    ...
    Downloadfunc(String name, InetAddress ftpSrvrUrl, String srvrAppDirectory, String pureFileNm, String fLocFileUrl, String usrNme, String psswrd) {
        threadName = name;
    ...
    public void run() {
        try {
            Global.DownloadFile(ftpserverurl,
                    serverAppDirectory,
                    PureFileName,
                    fullLocFileUrl,
                    userName,
